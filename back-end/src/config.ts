...
const jwt_access_expires: string | number = process.env.JWT_ACCESS_EXPIRES || "15m";
const jwt_refresh_expires: string | number = process.env.JWT_REFRESH_EXPIRES || "7d";
...
export { http,host, port, cors_origin, jwt_access_secret, jwt_refresh_secret, jwt_access_expires, jwt_refresh_expires, db, development };